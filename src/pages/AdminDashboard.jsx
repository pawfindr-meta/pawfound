...
export default function AdminDashboard() {
  ...
  // Instant Manual Collar State Triggers (ON / OFF)
          ...
          >
            ...
            {activeView === 'simulator' && (
              <div className="flex-1 flex flex-col gap-3.5 overflow-hidden">
                ...
                <div className="bg-night-2 border border-white/8 rounded-2xl p-3 flex items-center justify-between flex-wrap gap-2">
                  <div className="flex items-center gap-2">
                ...
                <div className="bg-night-2 border border-white/8 rounded-2xl p-3 flex flex-col gap-2.5">
                ...
                {/* Grouped Pet Selector by Owner */}
                <div className="flex-1 flex flex-col overflow-hidden">
                  <span className="text-xs font-semibold text-copper mb-2 flex items-center gap-1">
                    <PawPrint size={14} /> Select Pets (Categorized by Owner)
                  </span>

                  <div className="flex-1 overflow-auto custom-scrollbar flex flex-col gap-3 pr-1">
                    {owners.map((owner) => {
